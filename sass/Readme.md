...
folder are mapped to the application's root namespace, 'SimpleCMS1'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SimpleCMS1"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SimpleCMS1' in the same way
as `"SimpleCMS1/sass/src"`.
